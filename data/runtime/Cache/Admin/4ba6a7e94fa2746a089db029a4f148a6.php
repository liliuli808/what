...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Admin/Station/C_stationAdd'); ?>">新建水站</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Admin/Station/C_stationAdd'); ?>">
			<fieldset>
			...
			<!-- 	<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
                        <input type="text" name="tel" require="require" tips="水站负责人电话">
						<span class="form-required">*</span>
					</div>
				</div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea style="width:400px; height:60px;resize: none;" type="text" name="desc" require="require" tips="水站备注"></textarea>
                        <span class="form-required">*</span>
                    </div>
                </div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="text" id="address" name="address" require="require" tips="水站地址" style="width: 485px;">
                        <input type="text" id="address-gps" name="address_gps" require="require" tips="水站地址" style="display: none;">
						<input type="text" id="range" name="range" require="require" tips="水站服务范围不能为空" style="display: none;">
					</div>
				</div>
			</fieldset>
