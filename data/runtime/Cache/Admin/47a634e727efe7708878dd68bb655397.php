...
<body>
<form action="<?php echo U('Admin/Order/doAddOrder');?>" method="post">
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo U('Admin/Order/C_orderList'); ?>">订单列表</a></li>
        <li class="active"><a href="<?php echo U('Admin/Deliver/C_addOrder'); ?>">修改水工信息</a></li>
    </ul>
        ...
        <div class="span9">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <div id="l-map" ></div>
                        <input type="text" id="suggestId" size="20" placeholder="送货地址" style="width:266px;" />
                ...
                <tr>
                    ...
                    <td>
                        <select name="commity" id="commity">
                            <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>"><?php echo ($val["name"]); echo ($val["price"]); ?>元/<?php echo ($val["unit"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    $(function() {
        ...
        function pointInStationRange(point) {
            var stations = [];
            var _rangePolygon = JSON.parse('<?php echo ($station); ?>');
