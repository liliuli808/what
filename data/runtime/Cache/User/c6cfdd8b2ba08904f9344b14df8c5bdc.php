...
<meta name="author" content="ThinkCMF">
    ...
    <![endif]-->
	<link rel="icon" href="/htdocs/themes/simplebootx/Public/assets/images/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/htdocs/themes/simplebootx/Public/assets/images/favicon.ico" type="image/x-icon">
    <link href="/htdocs/themes/simplebootx/Public/assets/simpleboot/themes/simplebootx/theme.min.css" rel="stylesheet">
    <link href="/htdocs/themes/simplebootx/Public/assets/simpleboot/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="/htdocs/themes/simplebootx/Public/assets/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
	<!--[if IE 7]>
	<link rel="stylesheet" href="/htdocs/themes/simplebootx/Public/assets/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
	<link href="/htdocs/themes/simplebootx/Public/assets/css/style.css" rel="stylesheet">
	<style>
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/htdocs/"><img src="/htdocs/themes/simplebootx/Public/assets/images/logo.png"/></a>
 ...
 $effected_id="main-menu"; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="li-class" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
		...
		<ul class="nav pull-right" id="main-menu-user">
			...
			<li class="dropdown user login">
	            ...
	            <img src="/htdocs/themes/simplebootx/Public/assets/images/headicon.png" class="headicon"/>
          	...
          	<li class="dropdown user offline">
	            <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
	           		<img src="/htdocs/themes/simplebootx/Public/assets/images/headicon.png" class="headicon"/>登录<b class="caret"></b>
	            </a>
	            <ul class="dropdown-menu pull-right">
                               ...
                               <div class="tab-content">
                                   <div class="tab-pane active" id="one">
                                   		  ...
                                   		  <a href="<?php echo U('profile/avatar');?>">
                                   			<?php if(empty($avatar)): ?><img src="/htdocs/themes/simplebootx/Public/assets/images/headicon_128.png" class="headicon"/>
								            <?php else: ?>
...
var GV = {
   ...
   <script src="/htdocs/themes/simplebootx/Public/assets/simpleboot/bootstrap/js/bootstrap.min.js"></script>
   <script src="/htdocs/public/js/frontend.js"></script>
<script>
$(function(){
