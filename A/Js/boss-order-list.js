        ...
        for(var i=0; i<orders.length; ++i){
            ...
            if(order['deliver_type'] == 1){
                var orderHtml = '<div class="ticke-goods-item">'+
                    ...
                    '<a href="'+Api.U('boss-order-detail.html', {oid:order['order_id']})+'">'+
                    '<div class="order-row row">'+
                    '<div class="col-10-6-6" style="width: 100%;">'+
                    '<span class="OrderID>订单号'+order['order_sn']+'</span>'+
                    '</div>'+
                    '</div>'+
                    '</a>'+
                        // '<div class="order-row row">'+
                        ...
                        // '</div>'+
                    '<div class="row">'+
                    '<div class="order-label-name">'+order['create_times']+'</div>'+
                    ...
                    '<span class="Order-timer-orders">已派单</span>'+
                    '</div>'+
                    '</div>'+
                    '</div>'+
                    '</div>';
                ...
                var orderHtml = '<div class="ticke-goods-item">'+
                    ...
                    '</a>'+
                        ...
                        // '</div>'+
                    '<div class="row">'+
                    '<div class="order-label-name">订单时间:'+order['create_times']+'</div>'+
                    '<div class="order-label-name">'+order['address_name']+' （'+order['address_tel']+'）</div>'+
                    '<div class="order-valuee">地址：'+
                    '<span id="order-order-status">'+order['address_pcd']+order['address_detail']+'</span>'+
                    '</div>'+
